...
namespace t324inc\Composer\Plugin;
...
class D324Updater implements PluginInterface, EventSubscriberInterface, Capable{
  ...
  {
      return array(
          'Composer\Plugin\Capability\CommandProvider' => 't324inc\Composer\Commands\CommandsProvider'
      );
  }
   ...
   *    Drupal root path.
   */
  protected function getDrupalRoot($project_root, $rootPath = "web") {
  ...
  protected function writePatchReport($packageName, $packagePath, $patchUrl, $description, $isApplied, $directory) {
    ...
    if (!file_exists($logFile)) {
        $output = "This file was automatically generated by D324 Updater (https://github.com/t324inc/d324-updater)\n";
